...
StringBuilder is non-synchronised i.e. not thread safe. This means two threads can call the methods of StringBuilder simultaneously. StringBuilder is more efficient than StringBuffer.
*/
